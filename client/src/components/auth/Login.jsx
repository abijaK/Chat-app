    ...
    <div className="bg-img mx-auto bg-cover flex flex-col items-center justify-center min-h-screen py-2 ">
      <main className="md:w-[100vw] flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <div className="bg-cabin-blue  bg-opacity-40 rounded-tl-2xl rounded-tr-2xl shadow-2xl flex w-2/3 max-w-4xl">
          <div className="w-2/5 text-white rounded-tl-2xl py-36 px-12">
            {/* Sign up section */}
          ...
          <div
            className="text-left text-white font-bold absolute mt-5 ml-8 border-b border-r rounded border-teal-100 
                px-2"
          >
          ...
          {/* FORM Section */}
          <form
            className="w-3/5 py-16 bg-white bg-opacity-40 gap-8 rounded-tr-2xl rounded-bl-2xl flex flex-col items-center"
            ...
            <div className="input-item">
              <div className="w-80 mb-5">
                <label htmlFor="remember" className="text-xs flex justify-between">
                  <span className="flex text-cyan-900">
                    <input type="checkbox" name="remember" className="mr-1" />
                    Remember me
                  </span>
                  <a href="/edit/password" className="text-cyan-900 font-semibold">
                    Forgot Password ?
                  </a>
                </label>
              </div>
              ...
              {/* Sign-up Button */}
              <button
                className="loginBtn w-80 rounded py-2 text-cyan-900 font-semibold bg-constancia-blue hover:text-white hover:bg-opacity-70"
                type="submit"
              >
                Login
              </button>
